  ...
  return (
    <div className="relative bg-gradient-to-br from-navy-dark via-navy to-blue-700 py-20 px-6 text-center overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <h1 className="font-display text-5xl font-black text-white mb-3">Contact Us</h1>
        <p className="text-white/70 text-lg max-w-md mx-auto">
          Have a question, want to volunteer, or partner with us? We would love to hear from you.
        </p>
      </div>
    </div>
  )
